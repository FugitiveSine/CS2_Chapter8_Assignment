...
while(programRun == true){
	...
	clearCin();
		...
		case '2':
			...
			cout << "Enter 'D' to Bubble sort Descending or enter 'A' for Bubble Sort of Ascending: ";
			cin >> DorA;
			clearCin();
		...
		case '3':
			...
			cout << "Enter 'D' to Selection Sort Descending or enter 'A' for Selection Sort of Ascending: ";
			cin >> DorA;
			clearCin();
		...
		case '4':
			...
			if(intBinSearch(vectorArcticAnimals, pop) == true){
				...
				cout << "The population number searched for was not found" << endl;
			}
		...
		case '6':
			...
			cout << setw(15) << left << "Animal Name" << setw(18) << "Average Weight" << setw(18) << "Average Length" << setw(14) << "Population" << setw(14) << "Endangered" << setw(14) << "Food Source" << endl;
			cout << setw(15) << left << "===========" << setw(18) << "==============" << setw(18) << "==============" << setw(14) << "==========" << setw(14) << "==========" << setw(14) << "===========" << endl;
			...
			cout << setw(15) << left << vectorArcticAnimals[i].name << setw(18) << vectorArcticAnimals[i].avgWeight << setw(18) << vectorArcticAnimals[i].avgLength << setw(14) << vectorArcticAnimals[i].population
					<< setw(14) << YorN << setw(14) << vectorArcticAnimals[i].foodSource << endl;
			}
			break;
		case 'x':
